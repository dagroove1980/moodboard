...
export const metadata: Metadata = {
  title: 'About',
  description: 'Learn about MoodboardCards — curated aesthetic kits for designers, marketers, and creators.',
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
      <h1 className="text-3xl sm:text-4xl font-bold tracking-tight mb-8">
        About MoodboardCards
      </h1>

      <div className="space-y-6 text-base leading-relaxed text-[var(--color-foreground)]">
        <p>
          <strong>MoodboardCards</strong> is a curated collection of aesthetic kits — complete
        ...
        <p className="text-sm text-[var(--color-secondary)]">
          ...
          <a href="mailto:hello@moodboard-cards.com" className="text-[var(--color-accent)] hover:underline">
            hello@moodboard-cards.com
          </a>
        </p>
      </div>
